  ...
  return (
    <>
      <Hero
        ...
        subtitle="An unpatched or misconfigured firewall is an open door. Audcomp&apos;s technicians in Canada monitor, patch, and tune your network perimeter 24/7, so it keeps doing its job as threats evolve."
