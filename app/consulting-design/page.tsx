  ...
  return (
    <>
      <Hero
        ...
        subtitle="Know exactly where your IT stands before you spend, Audcomp's technicians in Canada assess your environment, flag the risks, and design what fits your budget."
