...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    description: `Audcomp delivers managed IT, cloud, and cyber security to ${cityName} businesses with Canadian technicians and 24/7 support. Top 25 CDN Solutions Provider.`,
  };
}
...
export default async function LocalItSupportPage({ params }: Props) {
  ...
  const services = [
    ...
    },
    {
      ...
      description: "Microsoft 365, Azure, and hybrid cloud deployment fully managed by our Canadian technicians.",
