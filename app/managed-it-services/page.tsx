...
const subServices = [
  {
    ...
    description: "End-user support, network, infrastructure, core application, data protection, and cyber security — with 24/7 coverage and 100% Canadian engineers.",
      ...
      <section className="bg-background py-20 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-muted-foreground text-lg leading-relaxed mb-6">
            Our Managed IT Services allow you to store your data, secure your network, and optimize your IT, while reducing your costs, maximizing your uptime, and increasing your productivity. Our team of 100% Canadian engineers monitors your environment around the clock, resolving issues before they become outages.
          </p>
          <p className="text-muted-foreground text-lg leading-relaxed mb-6">
