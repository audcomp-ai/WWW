  ...
  return (
    <>
      <Hero
        ...
        subtitle="Move to Microsoft 365 and Azure without the downtime or surprise bills, planned, migrated, and managed by Canadian technicians, with your data in Canadian data centres."
