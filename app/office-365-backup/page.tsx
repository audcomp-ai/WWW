...
export const metadata: Metadata = {
  ...
  description:
    "Audcomp's Office 365 Backup protects your Microsoft 365 data with AES-256 encryption, up to 5x faster recovery, and flexible retention policies.",
};
  ...
  return (
    <>
      <Hero
        ...
        subtitle="Microsoft doesn't back up your Microsoft 365 data. Audcomp does, with independent encrypted backup and up to 5x faster recovery."
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              { title: "AES-256 Encryption", desc: "In transit and at rest, stored in Canadian data centres." },
      ...
      <CTABanner
        ...
        subtitle="Add independent backup to your Microsoft 365 environment today."
      />
    </>
  );
}
