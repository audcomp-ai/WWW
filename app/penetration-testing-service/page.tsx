    ...
    <>
      ...
      <section className="bg-white py-20 px-4">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl font-bold text-foreground mb-6">Continuous Security Validation</h2>
      ...
      <section className="bg-gray-50 py-20 px-4">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-3xl font-bold text-foreground mb-12 text-center">Program Highlights</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
            {[
              { value: "4/yr", label: "Tests per Year" },
              { value: "48hr", label: "Report Turnaround" },
              { value: "Manual+", label: "Automated Testing" },
              { value: "In Canada", label: "Security Team" },
            ].map((s) => (
