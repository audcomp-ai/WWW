...
export const metadata: Metadata = {
  title: "Backup & Disaster Recovery | Audcomp ABS, Encrypted Cloud Backup",
  description:
    "Audcomp's ABS (Audcomp Backup Services) delivers AES-256 encrypted cloud backup with up to 5x faster recovery, automated continuous backups, and up to 7-year retention.",
};
        ...
        <div className="max-w-5xl mx-auto">
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-6 mb-16 text-center">
            {[
              ...
              { value: "In Canada", label: "Data Centres" },
            ].map((s) => (
