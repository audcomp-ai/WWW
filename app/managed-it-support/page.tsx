...
export const metadata: Metadata = {
  title: "Managed IT Support | Audcomp, 24/7 Canadian Technicians",
  description:
    "Audcomp's Managed IT Support provides end-user support, network management, and infrastructure monitoring with Canadian technicians and 24/7 coverage.",
};
  ...
  return (
    <>
      <Hero
        ...
        subtitle="End-user support, network management, and 24/7 monitoring, delivered by Canadian technicians who know your environment."
        ctaText="Get Started"
        ctaHref="/contact"
