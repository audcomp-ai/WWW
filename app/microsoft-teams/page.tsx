...
export default function MicrosoftTeamsPage() {
  return (
    <>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            {[
              ...
              { title: "SharePoint Integration", desc: "Connect Teams channels to SharePoint document libraries so files live in one place." },
      ...
      <CTABanner
        title="Ready to Roll Out Teams Across Your Organization?"
