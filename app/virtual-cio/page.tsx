  ...
  return (
    <>
      <Hero
        ...
        subtitle="Get executive-level IT strategy and a documented technology roadmap, without the cost of a full-time C-suite hire. Delivered by Audcomp's Canadian technicians."
