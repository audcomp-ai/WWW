...
const industries = [
  ...
  },
  {
    ...
    solution:
      "We help municipalities modernize their IT infrastructure cost-effectively, with technicians in Canada, compliant data handling, and a Virtual CIO to guide long-term technology planning.",
    services: [
  ...
  },
  {
    ...
    solution:
      "From campus networking and Microsoft 365 deployment to secure research data environments, Audcomp manages the complexity so faculty and students experience reliable, secure connectivity.",
    services: [
