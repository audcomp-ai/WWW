  ...
  return (
    <>
      <Hero
        ...
        subtitle="Turn Microsoft 365 Copilot into real productivity gains, Audcomp's Canadian technicians handle readiness, secure deployment, and adoption."
      ...
      <section className="bg-white py-20 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-gray-600 text-lg leading-relaxed">
            As a Microsoft partner with deep Microsoft 365 and Azure expertise, and a team of Canadian technicians, Audcomp integrates Copilot into your existing environment with minimal disruption and measurable results.
          </p>
        </div>
      </section>
